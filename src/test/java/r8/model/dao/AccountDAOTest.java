...
class AccountDAOTest {
    ...
    static void setUpBeforeTesting() {
        ...
        account1 = new Account("etunimi", "sukunimi", "email321" + Integer.toString(rand.nextInt(1000)), "pwd");
        account2 = new Account("etunimi2", "sukunimi2", "email4321"+ Integer.toString(rand.nextInt(1000)), "pwd2");
    }
